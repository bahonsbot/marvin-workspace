    ...
    <svg className="trading-mini-chart" viewBox={`0 0 ${width} ${height}`} role="img" aria-label="Sample portfolio performance chart">
      <defs>
        <linearGradient id="tradingChartFill" x1="0" x2="0" y1="0" y2="1">
          <stop offset="0%" stopColor="rgba(55, 84, 72, 0.2)" />
          <stop offset="100%" stopColor="rgba(55, 84, 72, 0)" />
        </linearGradient>
      </defs>
      <path d={`M0,${height - 8} L ${points} L ${width},${height - 8} Z`} fill="url(#tradingChartFill)" />
      <polyline points={points} fill="none" stroke="#223d33" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
      <line x1="0" y1={height - 8} x2={width} y2={height - 8} stroke="rgba(28,37,32,0.14)" />
    </svg>
  );
}
