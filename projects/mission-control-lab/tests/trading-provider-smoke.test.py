...
class TradingProviderSmokeTests(unittest.TestCase):
    ...
    def test_analytics_page_is_valuation_workbench_without_portfolio_lens(self) -> None:
        ...
        self.assertIn("Evidence loads after analysis", workbench)
        self.assertIn("Models unlock after analysis", workbench)
        self.assertIn("Select ticker first", workbench)
        self.assertIn("Assumptions pending", workbench)
