...
class TradingProviderSmokeTests(unittest.TestCase):
    ...
    def test_analytics_page_is_valuation_workbench_without_portfolio_lens(self) -> None:
        ...
        self.assertIn("buildQuickValuation", (ROOT / "lib" / "trading" / "valuation" / "quick-valuation.ts").read_text(encoding="utf-8"))
        self.assertIn("QuickValuationResult", (ROOT / "lib" / "trading" / "valuation" / "quick-valuation.ts").read_text(encoding="utf-8"))
        self.assertIn("DCF proxy", (ROOT / "lib" / "trading" / "valuation" / "quick-valuation.ts").read_text(encoding="utf-8"))
        self.assertIn("getDefeatBetaAnalyticsSummary", (ROOT / "app" / "api" / "trading" / "valuation" / "quick" / "route.ts").read_text(encoding="utf-8"))
