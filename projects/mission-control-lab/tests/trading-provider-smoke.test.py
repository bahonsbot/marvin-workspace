...
class TradingProviderSmokeTests(unittest.TestCase):
    ...
    def test_analytics_page_is_valuation_workbench_without_portfolio_lens(self) -> None:
        ...
        self.assertIn("GATEWAY_CALL_TIMEOUT_MS = 90_000", milou_route_source)
        self.assertIn("ANSWER_HISTORY_LIMIT = 30", milou_route_source)
        self.assertIn("17_000", milou_route_source)
