...
class TradingProviderSmokeTests(unittest.TestCase):
    ...
    def test_analytics_page_is_valuation_workbench_without_portfolio_lens(self) -> None:
        ...
        self.assertIn("Milou can answer all your questions and provide additional insights", workbench)
        ...
        self.assertIn("Use external web search when useful", workbench)
