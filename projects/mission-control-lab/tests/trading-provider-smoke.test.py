...
class TradingProviderSmokeTests(unittest.TestCase):
    ...
    def test_analytics_page_is_valuation_workbench_without_portfolio_lens(self) -> None:
        ...
        self.assertIn("agent:main:main", (ROOT / "app" / "api" / "trading" / "milou-analysis" / "route.ts").read_text(encoding="utf-8"))
        self.assertIn("Milou trading-advisor specialist seat", (ROOT / "app" / "api" / "trading" / "milou-analysis" / "route.ts").read_text(encoding="utf-8"))
