...
- Current product calibration (Mar 27):
  ...
  - Mar 30 Chat reopen priorities: if Chat is reopened later, prioritize (1) effort/thinking source-of-truth readback, (2) smarter multi-tool burst grouping, and only then lower-priority Composer/top-strip polish; do not reopen casually for broad redesign.
